...
<template>
  <Card
    v-if="page"
    as="article"
    class="bg-gray-50 dark:bg-gray-800 flex flex-col lg:flex-row space-y-8 lg:space-y-0 space-x-0 lg:space-x-8"
  >
    ...
    <div
      class="flex flex-col items-start justify-center w-full lg:w-2/3 space-y-4"
    >
      <h2
        class="text-2xl font-bold tracking-tight text-primary dark:text-white"
      >
        {{ page.title }}
      </h2>
